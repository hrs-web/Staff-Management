    ...
    <form action="${pageContext.request.contextPath}/updateUserServlet" method="post">
        ...
        <div class="form-group">
            ...
            <select name="address" class="form-control" >
                ...
                <c:if test="${user.address == '清远'}">
                    <option value="广州">广州</option>
                    <option value="深圳">深圳</option>
                    <option value="清远" selected>清远</option>
                    <option value="中山">中山</option>
                    <option value="惠州">惠州</option>
                </c:if>
                <c:if test="${user.address == '中山'}">
                    <option value="广州">广州</option>
                    <option value="深圳">深圳</option>
                    <option value="清远">清远</option>
                    <option value="中山" selected>中山</option>
                    <option value="惠州">惠州</option>
                </c:if>
                <c:if test="${user.address == '惠州'}">
                    <option value="广州">广州</option>
                    <option value="深圳">深圳</option>
                    <option value="清远">清远</option>
                    <option value="中山">中山</option>
                    <option value="惠州" selected>惠州</option>
                </c:if>
